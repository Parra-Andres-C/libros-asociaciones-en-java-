...
public class PruebaLibro {
    public static void main(String[] args) {
        ...
        ConjuntoLibro biblio = new ConjuntoLibro(20);
        biblio.anadirLibro(libro1);
        biblio.anadirLibro(libro2);
        biblio.anadirLibro(libro3);
        Libro[] l = biblio.mostrarLibros();
        for ( int i = 0; i < 20; i++){
            System.out.println(l[i]);
        }
        biblio.eliminarxAutor("G");
        System.out.println("se elimino un libro por autor");
        for ( int i = 0; i < 20; i++){
            System.out.println(l[i]);
        }
        System.out.println("se agregara un nuevo libro en la posicion del libro eliminado");
